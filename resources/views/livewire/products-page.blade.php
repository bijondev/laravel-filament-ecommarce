                ...
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="cat-{{ $category->id }}" class="flex items-center dark:text-gray-400 "
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="brand-{{ $brand->id }}" class="flex items-center dark:text-gray-300"
                                    wire:key="{{ $brand->id }}">
                                    <input wire:model.live="selected_brands" type="checkbox" class="w-4 h-4 mr-2"
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" class="w-4 h-4 mr-2" id="featured" value="1"
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-semibold">{{ '৳' . Number::format($price_range, 2) }}</div>
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                            <div class="border border-gray-300 dark:border-gray-700">
                                ...
                                <div class="p-3 ">
                                    ...
                                    <p class="text-lg ">
                                        <span
                                            class="text-green-600 dark:text-green-600">{{ '৳' . Number::format($product->price, 2) }}</span>
                                    </p>
                                </div>
                                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                                    <a wire:click.prevent='addTocart({{$product->id}})' href="javascript(return;)"
                                        ...
                                        </svg><span wire:loading.remove wire:target='addToCart({{$product->id}}'>Add to
